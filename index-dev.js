...
(async function main()
{
    ...
    let options = { credentials: { accessKeyId : accessKeyId, secretAccessKey: secretAccessKey, clientConfig: { region : region} }, region: region };
    //let options = { accessKeyId : accessKeyId, secretAccessKey: secretAccessKey, region: region };
